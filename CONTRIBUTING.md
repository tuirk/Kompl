...
- **GitHub issues** — browse [open issues](https://github.com/tuirk/Kompl/issues) for planned work, bugs, and ideas. Anything labelled `good first issue` is a deliberately scoped entry point.
