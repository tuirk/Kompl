...
/**
 * OnboardingClient — connector selection screen (client body).
 *
 * Rendered by the server shell at /onboarding when no other compile session
 * is active. Generates a session_id (UUID) on mount, stores it in
 * sessionStorage. User checks active connectors → "Next →" navigates to the
 * first connector screen, passing session_id as a URL search param.
 */
